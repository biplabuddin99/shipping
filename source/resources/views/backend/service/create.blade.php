            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route(Session::get('identity').'.service.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="tab-pane" id="account-2">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="long_description">Details</label>
                                                    <div class="col-md-9">
                                                        <textarea type="text" id="details" name="details" class="form-control summernote" rows="15">{{old('details')}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
