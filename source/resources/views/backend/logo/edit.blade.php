            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route(Session::get('identity').'.headerLogo.update',$headerLogo->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('patch')
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="file" class="dropify" data-height="150" value="{{old('Logo',$headerLogo->logo)}}" name="Logo"/>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12">
