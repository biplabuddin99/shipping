                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset($head->logo)}}" height="80" width="267" alt=""></td>
                                    <td>

                                         <a href="{{route(Session::get('identity').'.headerLogo.edit',$head->id)}}" class="btn btn-primary btn-sm btn-rounded width-xs waves-effect">Edit</a>
                                 </td>
                                </tr>
