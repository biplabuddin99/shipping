            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route(Session::get('identity').'.company.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                    <textarea type="text" id="short_description" name="short_description" class="form-control" rows="5">{{old('short_description')}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea type="text" id="long_description" name="long_description" class="form-control summernote" rows="15">{{old('long_description')}}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
