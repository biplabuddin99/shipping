        ...
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" action="{{route(Session::get('identity').'.homefootsocial.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        
                        <div class="form-group row">
                            <label for="title" class="col-sm-3 col-form-label">Facebook</label>
                            <div class="col-sm-9">
                                <input type="text" name="facebook" class="form-control @if($errors->has('facebook')) parsley-error @endif" id="title" placeholder="facebook">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="twitter" class="form-control @if($errors->has('twitter')) parsley-error @endif" id="details" placeholder="twitter">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="whatsapp" class="form-control @if($errors->has('whatsapp')) parsley-error @endif" id="c_notice" placeholder="whatsapp">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="linkedin" class="form-control @if($errors->has('linkedin')) parsley-error @endif" id="c_notice" placeholder="linkedin ">
