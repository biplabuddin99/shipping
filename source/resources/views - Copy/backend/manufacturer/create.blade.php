        ...
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" action="{{route(Session::get('identity').'.manufacturer.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="email" class="form-control @if($errors->has('email')) parsley-error @endif" id="email" placeholder="Email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="contact" class="form-control @if($errors->has('contact')) parsley-error @endif" id="contact" placeholder="Contact">
