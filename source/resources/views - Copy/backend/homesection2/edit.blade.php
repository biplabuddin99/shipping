                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route(Session::get('identity').'.homesec2.index')}}">HomeSection2</a></li>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title mb-3">HomeSection2 Details form</h4>

                        <form action="{{route(Session::get('identity').'.homesec2.update',$data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="tab-pane" id="profile-tab-2">
                                        <div class="row">
                                            ...
                                            @if($data->homesection2image)
                                                @foreach ($data->homesection2image as $i=>$item)
