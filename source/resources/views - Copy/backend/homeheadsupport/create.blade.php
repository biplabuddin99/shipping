            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route(Session::get('identity').'.headersupport.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="title1" name="title1" value="Title">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="details1">Details</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="details1" name="details1" class="form-control" value="Details">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="image1">Image</label>
                                                    <div class="col-md-9">
                                                        <input type="file" class="dropify" data-height="150" name="image1"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="title2" name="title2" value="Title">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="details2">Details</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="details2" name="details2" class="form-control" value="Details">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="image2">Image</label>
                                                    <div class="col-md-9">
                                                        <input type="file" class="dropify" data-height="150" name="image2"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="title3" name="title3" value="Title">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="details3">Details</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="details3" name="details3" class="form-control" value="Details">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="image3">Image</label>
                                                    <div class="col-md-9">
                                                        <input type="file" class="dropify" data-height="150" name="image3"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="title4" name="title4" value="Title">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="details4">Details</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="details4" name="details4" class="form-control" value="Details">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="image4">Image</label>
                                                    <div class="col-md-9">
                                                        <input type="file" class="dropify" data-height="150" name="image4"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row mb-3">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" id="title5" name="title5" value="Title">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="details5">Details</label>
                                                    <div class="col-md-9">
                                                        <input type="text" id="details5" name="details5" class="form-control" value="Details">
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="image5">Image</label>
                                                    <div class="col-md-9">
                                                        <input type="file" class="dropify" data-height="150" name="image5"/>
                                                    </div>
                                                </div>
