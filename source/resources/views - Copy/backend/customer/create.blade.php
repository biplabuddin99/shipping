    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card-box">
                    <h4 class="mt-0 mb-3 header-title">Add New Customer</h4>
				    ...
				    @endif
                    <form class="form-horizontal" role="form" action="{{route(Session::get('identity').'.admincustomer.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group row">
                            <label for="first_name" class="col-sm-3 col-form-label">First Name</label>
                            <div class="col-sm-9">
                                <input type="text" name="first_name" class="form-control @if($errors->has('first_name')) parsley-error @endif" id="first_name" placeholder="First Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="last_name" class="form-control @if($errors->has('last_name')) parsley-error @endif" id="last_name" placeholder="Last Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="email" name="email" class="form-control @if($errors->has('email')) parsley-error @endif" id="email" placeholder="Email">
                                @if ($errors->has('email'))
                                    <ul class="parsley-errors-list filled">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <input type="text" name="contact" class="form-control @if($errors->has('contact')) parsley-error @endif" id="contact" placeholder="XXXXXXXXXX">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <textarea name="address" class="form-control @if($errors->has('address')) parsley-error @endif" id="address"></textarea>
