...
<div class="wrapper">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">HomeSection3</li>
                        </ol>
                    </div>
        ...
        <div class="card-box">
          <div>
            <a href="{{route(Session::get('identity').'.homesec3.edit')}}" class="btn btn-primary btn-rounded width-sm waves-effect">Edit</a>
          </div>
                      ...
                      <div class="cs-text_box cs-style1">
                        ...
                        <div class="cs-text_box_brand">
                          ...
                          <div class="cs-text_box_brands">
                            @if ($data[0]->homesection3image)
                            @foreach ($data[0]->homesection3image as $item)
