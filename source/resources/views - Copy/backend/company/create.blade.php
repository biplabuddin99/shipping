        ...
        <div class="row">
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" action="{{route(Session::get('identity').'.company.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" class="form-control @if($errors->has('name')) parsley-error @endif" id="inputEmail3" placeholder="Whatsapp Number">
