        ...
        <div class="row">
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" action="{{route(Session::get('identity').'.company.update',$company->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="file" value="{{($company->feature_image)}}" class="dropify" data-height="150" name="image"/>
                                @if ($errors->has('image'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="name" value="{{($company->name)}}" class="form-control @if($errors->has('name')) parsley-error @endif" id="inputEmail3" placeholder="Company Name">
