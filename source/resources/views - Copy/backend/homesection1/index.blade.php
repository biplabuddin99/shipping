...
<div class="wrapper">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Home Section 1</li>
                        </ol>
                    </div>
        ...
        <div class="card-box">
          <div>
            <a href="{{route(Session::get('identity').'.homesec1.edit')}}" class="btn btn-primary btn-rounded width-sm waves-effect">Edit</a>
        </div>
