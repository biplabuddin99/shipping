                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home Section 1</a></li>
                            <li class="breadcrumb-item active">Update</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Home Section 1</h4>
                </div>
            </div>
        </div>     
        <!-- end page title --> 
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title mb-3">HomeSection1 Details form</h4>

                        <form action="{{route(Session::get('identity').'.homesec1.update',$data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="tab-pane" id="profile-tab-2">
                                        <div class="row">
                                            ...
                                            @if($data->homesection1image)
                                                @foreach ($data->homesection1image as $i=>$item)
