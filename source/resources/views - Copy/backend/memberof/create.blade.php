                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home Section_1</a></li>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route(Session::get('identity').'.memberof.store')}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="tab-pane" id="account-2">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="details1">Link</label>
                                                    <div class="col-md-9">
                                                        <textarea type="text" id="details1" name="details1" class="form-control" rows="5">Link </textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-3 col-form-label" for="fimage">Logo</label>
                                                    <div class="col-md-9">
