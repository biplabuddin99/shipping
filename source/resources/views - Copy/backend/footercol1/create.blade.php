        ...
        <div class="row">
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card-box">
                    ...
                    <form class="form-horizontal" role="form" action="{{route(Session::get('identity').'.homefootcol1.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="title" class="form-control @if($errors->has('name')) parsley-error @endif" id="title" placeholder="Head">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="details" class="form-control @if($errors->has('details')) parsley-error @endif" id="details" placeholder="Details">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="c_notice" class="form-control @if($errors->has('c_notice')) parsley-error @endif" id="c_notice" placeholder="Copyright Notice">
