                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route(Session::get('identity').'.homesec4.index')}}">HomeSection4</a></li>
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="header-title mb-3">HomeSection4 Details form</h4>

                        <form action="{{route(Session::get('identity').'.homesec4.update',$data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <div class="tab-pane" id="profile-tab-2">
                                        <div class="row">
                                            @php
                                                $i=0;
                                            @endphp
                                            @if($data->homesection4image)
                                                @foreach ($data->homesection4image as $i=>$item)
