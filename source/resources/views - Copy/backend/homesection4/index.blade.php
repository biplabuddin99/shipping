...
<div class="wrapper">
    <div class="container-fluid">
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">HomeSection4</li>
                        </ol>
                    </div>
                    <h4 class="page-title">HomeSection4</h4>
                </div>
            </div>
        </div>      
        <!-- end page title --> 
        ...
        <div class="card-box">
          <div>
            <a href="{{route(Session::get('identity').'.homesec4.edit')}}" class="btn btn-primary btn-rounded width-sm waves-effect">Edit</a>
          </div>
                  ...
                  <div class="cs-vertical_middle">
                    <div class="cs-vertical_middle_in">
                      <div class="cs-text_box cs-style1">
                        <h3 class="cs-text_box_subtitle">{{$data[0]->title}}</h3>
                        <h2 class="cs-text_box_titel">{{$data[0]->heading1}}</br>
                          <span class="cs-accent_color">{{$data[0]->heading2}}</span></h2>
                        <div class="cs-text_box_text">{!!$data[0]->details!!}</div>
                        <div class="cs-text_box_brand">
                          <h4 class="cs-text_box_brand_title">Brand</h4>
                          <div class="cs-text_box_brands">
                            @if ($data[0]->homesection4image)
                            @foreach ($data[0]->homesection4image as $item)
                    ...
                    <div class="cs-image_box_2_wrap  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s">
                      <div class="cs-image_box cs-style2">
                        <div class="cs-image_box_shape">
                          <div class="cs-image_box_in cs-bg" style="background-image: url('{{ asset($data[0]->feature_image)}}');"></div>
                        </div>
                      </div>
                    </div>
                  </div>
